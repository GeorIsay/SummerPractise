...
class Swarm():
    def __init__(self):
        ...
        self.v_a = random.uniform(-1,1)
        self.v_b = random.uniform(-1,1)
        self.v_c = random.uniform(-1,1)
        self.v_d = random.uniform(-1,1)
...
D = [random.uniform(-100,100), random.uniform(-100,100)]
